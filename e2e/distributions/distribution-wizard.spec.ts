...
test.describe("Distributions", () => {
  ...
  test("should display calendar or list view", async ({ page }) => {
    ...
    const content = page.locator(
      '[class*="calendar"], [class*="list"], table, [data-testid="distributions-view"]',
    );
...
test.describe("Distribution Wizard", () => {
  test("should load new distribution page", async ({ page }) => {
    ...
    const formContent = page.locator(
      'form, [data-testid="wizard"], [class*="wizard"], [class*="step"]',
    );
  ...
  test("should display wizard steps", async ({ page }) => {
    ...
    const steps = page.locator(
      '[data-testid="step"], [class*="step"], [role="progressbar"]',
    );
...
test.describe("Distribution Details", () => {
  test("should access distribution details page", async ({ page }) => {
    ...
    const distributionItem = page
      .locator('[data-testid="distribution-item"], table tbody tr')
      .first();
    ...
    if (await distributionItem.isVisible()) {
      ...
      const detailsContent = page.locator(
        '[data-testid="distribution-details"], [class*="detail"]',
      );
