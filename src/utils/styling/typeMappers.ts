...
export const dealOutcomeClasses: Record<DealOutcome, string> = {
  ...
  withdrawn:
    "bg-[var(--app-text-muted)]/10 text-[var(--app-text-muted)] border-[var(--app-text-muted)]",
  passed:
    "bg-[var(--app-warning-bg)] text-[var(--app-warning)] border-[var(--app-warning)]",
  active:
    "bg-[var(--app-info-bg)] text-[var(--app-info)] border-[var(--app-info)]",
};
...
export type DistributionEventLabel =
  | DistributionEventType
  | "scheduled"
  | "reminder";

export const distributionEventTypeLabels: Record<
  DistributionEventLabel,
  string
> = {
  exit: "Exit",
  dividend: "Dividend",
...
export const alertTypeClasses: Record<AlertType, string> = {
  ...
  success:
    "bg-[var(--app-success-bg)] border-[var(--app-success)] text-[var(--app-success)]",
  warning:
    "bg-[var(--app-warning-bg)] border-[var(--app-warning)] text-[var(--app-warning)]",
  error:
    "bg-[var(--app-danger-bg)] border-[var(--app-danger)] text-[var(--app-danger)]",
};
