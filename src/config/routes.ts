...
export const routes: Record<string, RouteConfig> = {
  ...
  portfolio: {
    ...
    aiSuggestion: {
      label: 'Analytics',
      href: '/analytics',
      reasoning: 'After portfolio review, you frequently access analytics for deeper insights.',
    },
  ...
  fundAdmin: {
    ...
    aiSuggestion: {
      label: 'LP Management',
      href: '/lp-management',
      reasoning: 'Capital call operations often require LP communication, so LP data is usually needed next.',
    },
