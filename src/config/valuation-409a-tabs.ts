...
export const DEFAULT_VALUATION_409A_TAB_ID = VALUATION_409A_TABS[0]?.id ?? 'valuations';

export const VALUATION_409A_TAB_IDS = new Set(VALUATION_409A_TABS.map((tab) => tab.id));
