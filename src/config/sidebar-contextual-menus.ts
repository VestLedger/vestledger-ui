...
import { DEFAULT_ANALYTICS_TAB_ID, ANALYTICS_TABS } from "./analytics-tabs";
import { AI_TOOLS_TABS, DEFAULT_AI_TOOLS_TAB_ID } from "./ai-tools-tabs";
import {
  COLLABORATION_TABS,
  DEFAULT_COLLABORATION_TAB_ID,
} from "./collaboration-tabs";
import { COMPLIANCE_TABS, DEFAULT_COMPLIANCE_TAB_ID } from "./compliance-tabs";
import {
...
export const SIDEBAR_CONTEXTUAL_MENUS: Record<
  ContextualMenuId,
