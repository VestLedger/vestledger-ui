...
export const DEFAULT_LP_MANAGEMENT_TAB_ID = LP_MANAGEMENT_TABS[0]?.id ?? 'overview';

export const LP_MANAGEMENT_TAB_IDS = new Set(LP_MANAGEMENT_TABS.map((tab) => tab.id));
