...
export const DASHBOARD_DENSITY: Record<
  DashboardDensityMode,
  DashboardDensityScale
> = {
  compact: {
    mode: "compact",
    shell: {
    ...
    header: {
      ...
      tabsContentClass:
        "group-data-[selected=true]:text-[var(--app-primary)] text-[var(--app-text-muted)] font-medium text-sm",
    },
    cardPadding: {
      none: "p-0",
      sm: "p-2.5",
  ...
  comfortable: {
    ...
    header: {
      ...
      tabsContentClass:
        "group-data-[selected=true]:text-[var(--app-primary)] text-[var(--app-text-muted)] font-medium",
    },
    cardPadding: {
      none: "p-0",
      sm: "p-3",
...
export function resolveDashboardDensityMode(
  value: unknown,
): DashboardDensityMode {
