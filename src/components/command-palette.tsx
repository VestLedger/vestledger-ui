  ...
  const pages: CommandItem[] = isSuperadmin
    ...
    : [
        ...
        },
        {
          ...
          subtitle: "Capital calls, distributions, expenses, transfers",
          category: "Pages",
          icon: DollarSign,
          action: () => navigate(ROUTE_PATHS.workflowsFundOps),
          route: ROUTE_PATHS.workflowsFundOps,
          keywords: [
            "capital",
            "calls",
            "distributions",
        ...
        },
        {
          id: "compliance",
          title: "Compliance",
          subtitle: "Regulatory tracking and deadlines",
          category: "Pages",
          icon: FileText,
          action: () => navigate(ROUTE_PATHS.workflowsCompliance),
          route: ROUTE_PATHS.workflowsCompliance,
          keywords: ["regulatory", "filing", "audit", "compliance"],
        },
        {
          id: "collaboration",
          title: "Collaboration",
          ...
          category: "Pages",
          icon: MessageSquare,
          action: () => navigate(ROUTE_PATHS.workflowsCollaboration),
          route: ROUTE_PATHS.workflowsCollaboration,
    ...
    <>
      ...
      >
        ...
        <DialogDescription className="sr-only">
          Search for pages and actions, then press Enter to run the selected
          command.
        </DialogDescription>
