  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-[var(--app-border)] overflow-hidden">
        <div className="grid grid-cols-[140px_1fr_120px_120px_1fr_40px] gap-2 bg-[var(--app-surface-hover)] px-3 py-2 text-xs font-semibold text-[var(--app-text-muted)]">
        ...
        <div className="divide-y divide-[var(--app-border)]">
          ...
          {items.map((item) => (
            <div
              key={item.id}
              className="grid grid-cols-[140px_1fr_120px_120px_1fr_40px] gap-2 px-3 py-3"
            >
              <Select
