...
export function NAVCalculator({
  ...
  const getValuationMethodBadge = (method: NAVComponent['valuationMethod']) => {
    const colors = {
      'cost': 'bg-app-info-bg dark:bg-app-dark-info-bg text-app-info dark:text-app-dark-info',
      'fair-value': 'bg-app-success-bg dark:bg-app-dark-success-bg text-app-success dark:text-app-dark-success',
      'mark-to-market': 'bg-app-primary-bg dark:bg-app-dark-primary-bg text-app-primary dark:text-app-dark-primary',
      'discounted-cash-flow': 'bg-app-warning-bg dark:bg-app-dark-warning-bg text-app-warning dark:text-app-dark-warning',
    };
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <Calculator className="w-5 h-5 text-app-primary dark:text-app-dark-primary" />
                ...
                >
                  ...
                  {calc.changePercent !== undefined && (
                    <div className={`text-xs flex items-center gap-1 ${
                      calc.changePercent >= 0 ? 'text-app-success dark:text-app-dark-success' : 'text-app-danger dark:text-app-dark-danger'
                    }`}>
        ...
        {selectedCalculation ? (
          <div className="space-y-4">
            ...
            <Card padding="md">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-app-success-bg dark:bg-app-dark-success-bg">
                  <p className="text-xs font-medium text-app-text-muted dark:text-app-dark-text-muted mb-1">NAV per Share</p>
                  ...
                  {selectedCalculation.changePercent !== undefined && (
                    <div className={`text-sm mt-1 ${
                      selectedCalculation.changePercent >= 0 ? 'text-app-success dark:text-app-dark-success' : 'text-app-danger dark:text-app-dark-danger'
                    }`}>
                ...
                <div className="p-4 rounded-lg bg-app-primary-bg dark:bg-app-dark-primary-bg">
                  <p className="text-xs font-medium text-app-text-muted dark:text-app-dark-text-muted mb-1">Net Assets</p>
                ...
                <div className="p-4 rounded-lg bg-app-info-bg dark:bg-app-dark-info-bg">
                  <p className="text-xs font-medium text-app-text-muted dark:text-app-dark-text-muted mb-1">Total Assets</p>
            ...
            <Card padding="md">
              ...
              <div className="space-y-2">
                {selectedCalculation.components.map(component => (
                  <div
                    key={component.id}
                    className="flex items-center justify-between p-3 rounded-lg bg-app-surface-hover dark:bg-app-dark-surface-hover"
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-app-text-subtle dark:text-app-dark-text-subtle capitalize">
                        {component.category}
                      </p>
                    </div>
                  </div>
            ...
            {selectedCalculation.adjustments.length > 0 && (
              <Card padding="md">
                <div className="flex items-center gap-2 mb-3">
                  <AlertCircle className="w-4 h-4 text-app-warning dark:text-app-dark-warning" />
                ...
                <div className="space-y-2">
                  {selectedCalculation.adjustments.map(adjustment => (
                    <div
                      key={adjustment.id}
                      className="p-3 rounded-lg bg-app-warning-bg dark:bg-app-dark-warning-bg border border-app-warning dark:border-app-dark-warning"
                    >
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-sm font-medium">{adjustment.description}</span>
                            <Badge size="sm" variant="flat" className="bg-white/50 text-app-warning dark:text-app-dark-warning">
                              {adjustment.type.replace(/-/g, ' ')}
                            </Badge>
                          </div>
                          <p className="text-xs text-app-text-muted dark:text-app-dark-text-muted">{adjustment.justification}</p>
                        ...
                        <p className={`text-lg font-bold ${
                          adjustment.amount >= 0 ? 'text-app-success dark:text-app-dark-success' : 'text-app-danger dark:text-app-dark-danger'
                        }`}>
            ...
            {selectedCalculation.notes && (
              <Card padding="md">
                ...
                <p className="text-sm text-app-text-muted dark:text-app-dark-text-muted">{selectedCalculation.notes}</p>
              </Card>
            )}
          </div>
        ) : (
          <Card padding="md">
            <div className="text-center py-12">
              <Calculator className="w-12 h-12 mx-auto mb-3 text-app-text-muted dark:text-app-dark-text-muted opacity-50" />
              <p className="text-app-text-muted dark:text-app-dark-text-muted">Select a NAV calculation to view details</p>
            </div>
          </Card>
        )}
      </div>
