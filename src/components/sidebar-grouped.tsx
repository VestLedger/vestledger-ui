...
export function SidebarGrouped() {
  ...
  return (
    <motion.aside
      ...
      className="relative flex flex-col h-full overflow-hidden border-r border-app-border dark:border-app-dark-border bg-app-sidebar dark:bg-app-dark-sidebar"
      ...
      >
        {isSuperadmin ? (
          ...
          <>
            ...
            {isAccessible(
              navigationStructure.portfolioManagement.allowedRoles,
            ) && (
              <NavigationGroup
