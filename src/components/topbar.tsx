...
export function Topbar() {
  ...
  return (
    <div
      className={`${density.shell.topbarPaddingClass} border-b border-app-border dark:border-app-dark-border flex items-center justify-between sticky top-0 z-30 bg-app-surface dark:bg-app-dark-surface`}
      style={{
