...
export const integrationsSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.misc.integrations.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.misc.integrations.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.misc.integrations.status === "failed",
...
export const lpPortalSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.misc.lpPortal.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.misc.lpPortal.status === "succeeded",
...
export const lpManagementSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.misc.lpManagement.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.misc.lpManagement.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.misc.lpManagement.status === "failed",
...
export const auditTrailSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.misc.auditTrail.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.misc.auditTrail.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.misc.auditTrail.status === "failed",
...
export const companySearchSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.misc.companySearch.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.misc.companySearch.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.misc.companySearch.status === "failed",
...
export const collaborationSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.misc.collaboration.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.misc.collaboration.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.misc.collaboration.status === "failed",
