...
const initialState: DealIntelligenceState =
  createInitialAsyncState<DealIntelligenceData>();
...
const dealIntelligenceSlice = createSlice({
  ...
  reducers: {
    dealIntelligenceRequested: (
      state,
      _action: PayloadAction<GetDealIntelligenceParams>,
    ) => {
    ...
    dealIntelligenceLoaded: (
      state,
      action: PayloadAction<DealIntelligenceData>,
    ) => {
...
export const { dealIntelligenceLoaded, dealIntelligenceFailed } =
  dealIntelligenceSlice.actions;

// Centralized selectors
export const dealIntelligenceSelectors =
  createAsyncSelectors<DealIntelligenceData>("dealIntelligence");
