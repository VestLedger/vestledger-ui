...
const dashboardsSlice = createSlice({
  ...
  reducers: {
    ...
    analystDashboardLoaded: (
      state,
      action: PayloadAction<AnalystDashboardData>,
    ) => {
    ...
    auditorDashboardLoaded: (
      state,
      action: PayloadAction<AuditorDashboardData>,
    ) => {
    ...
    researcherDashboardLoaded: (
      state,
      action: PayloadAction<ResearcherDashboardData>,
    ) => {
...
export const lpDashboardSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.dashboards.lp.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.dashboards.lp.status === "succeeded",
...
export const analystDashboardSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.dashboards.analyst.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.dashboards.analyst.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.dashboards.analyst.status === "failed",
...
export const opsDashboardSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.dashboards.ops.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.dashboards.ops.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.dashboards.ops.status === "failed",
...
export const auditorDashboardSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.dashboards.auditor.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.dashboards.auditor.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.dashboards.auditor.status === "failed",
...
export const irDashboardSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.dashboards.ir.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.dashboards.ir.status === "succeeded",
...
export const researcherDashboardSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.dashboards.researcher.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.dashboards.researcher.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.dashboards.researcher.status === "failed",
