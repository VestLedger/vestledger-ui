...
const aiSlice = createSlice({
  ...
  reducers: {
    ...
    pitchDeckAnalysesRequested: (
      state,
      _action: PayloadAction<GetPitchDeckAnalysesParams>,
    ) => {
    ...
    ddChatConversationRequested: (
      state,
      _action: PayloadAction<GetDDChatConversationParams>,
    ) => {
...
export const pitchDeckSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.ai.pitchDeckState.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.ai.pitchDeckState.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.ai.pitchDeckState.status === "failed",
...
export const ddChatSelectors = {
  ...
  selectIsLoading: (state: RootState) =>
    state.ai.ddChatState.status === "loading",
  selectIsSucceeded: (state: RootState) =>
    state.ai.ddChatState.status === "succeeded",
  selectIsFailed: (state: RootState) =>
    state.ai.ddChatState.status === "failed",
