...
export const disconnectIntegrationOperation = createRefreshingIntegrationOperation(
...
export const configureCalendarRulesOperation = createRefreshingIntegrationOperation(
  'integrations/configureCalendarRules',
  configureCalendarRules
);

export const toggleCalendarAutoCaptureOperation = createRefreshingIntegrationOperation(
  'integrations/toggleCalendarAutoCapture',
  toggleCalendarAutoCapture
);

export const captureCalendarEventOperation = createRefreshingIntegrationOperation(
  'integrations/captureCalendarEvent',
  captureCalendarEvent
);

export const ignoreCalendarEventOperation = createRefreshingIntegrationOperation(
...
export const createCalendarEventOperation = createRefreshingIntegrationOperation(
