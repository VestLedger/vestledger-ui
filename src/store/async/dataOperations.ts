...
import {
  ...
  sleep,
} from "@/store/async/createLatestOperation";

export const fetchAlertsOperation = createLatestOperation<
  GetAlertsParams | undefined,
  { items: Awaited<ReturnType<typeof fetchAlertsService>> }
>({
...
export const loadDocumentsOperation = createLatestOperation<
  GetDocumentsParams,
...
export const loadPipelineDataOperation = createLatestOperation<
  GetPipelineParams,
  Awaited<ReturnType<typeof getPipelineData>>
>({
...
export const loadDealflowDealsOperation = createLatestOperation<
  GetDealflowDealsParams,
  Awaited<ReturnType<typeof getDealflowDeals>>
>({
...
export const loadDealIntelligenceOperation = createLatestOperation<
  GetDealIntelligenceParams,
  Awaited<ReturnType<typeof getDealIntelligenceData>>
>({
...
export const loadPortfolioUpdatesOperation = createLatestOperation<
  GetPortfolioUpdatesParams,
  PortfolioData
>({
...
export const loadCRMDataOperation = createLatestOperation<
  GetCRMDataParams,
  {
    ...
    timelineInteractions: Awaited<
      ReturnType<typeof getCRMTimelineInteractions>
    >;
  }
>({
  typePrefix: "crm/load",
...
export const loadLPDashboardOperation = createLatestOperation<
  void,
  Awaited<ReturnType<typeof getLPDashboardSnapshot>>
>({
...
export const loadAnalystDashboardOperation = createLatestOperation<
  void,
...
>({
  ...
  run: async () =>
    getAnalystDashboardSnapshot() as Promise<AnalystDashboardData>,
  onSuccess: (result) => analystDashboardLoaded(result),
  onFailure: (error) => analystDashboardFailed(error),
});

export const loadOpsDashboardOperation = createLatestOperation<
  void,
  OpsDashboardData
>({
...
export const loadAuditorDashboardOperation = createLatestOperation<
  void,
  Awaited<ReturnType<typeof getAuditorDashboardSnapshot>>
>({
...
export const loadIRDashboardOperation = createLatestOperation<
  void,
  IRDashboardData
>({
...
export const loadResearcherDashboardOperation = createLatestOperation<
  void,
  Awaited<ReturnType<typeof getResearcherDashboardSnapshot>>
>({
...
export const loadIntegrationsOperation = createLatestOperation<
  void,
  Awaited<ReturnType<typeof getIntegrationsSnapshot>>
>({
...
export const loadLPPortalOperation = createLatestOperation<
  void,
  Awaited<ReturnType<typeof getInvestorSnapshot>>
>({
...
export const loadLPManagementOperation = createLatestOperation<
  void,
  Awaited<ReturnType<typeof getLPManagementSnapshot>>
>({
...
export const loadAuditTrailOperation = createLatestOperation<
  void,
...
export const loadCompanySearchOperation = createLatestOperation<
  void,
  {
...
export const loadCollaborationOperation = createLatestOperation<
  void,
  Awaited<ReturnType<typeof getCollaborationSnapshot>>
>({
...
export const loadDDChatConversationOperation = createLatestOperation<
...
export const loadCopilotSuggestionsOperation = createLatestOperation<
  GetCopilotSuggestionsParams,
  Awaited<ReturnType<typeof getCopilotSuggestionsAndActions>>
>({
