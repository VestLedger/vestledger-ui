...
export const mockRoleOnboardingPlans: Record<UserRole, RoleOnboardingPlan> = {
    ...
    steps: [
      {
        ...
        description:
          "Verify tenant lifecycle, invitations, and provisioning queues.",
  ...
  gp: {
    ...
    description:
      "Align pipeline priorities, IC cadence, and LP comms in one pass.",
    steps: [
      {
        id: "gp-dashboard",
    ...
    steps: [
      {
        ...
        description:
          "Review capital calls, distributions, and status transitions.",
  ...
  strategic_partner: {
    ...
    description:
      "Review co-investment opportunities and provide deal feedback.",
    steps: [
      {
        id: "partner-dealflow",
