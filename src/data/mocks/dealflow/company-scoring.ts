  ...
  1: {
    ...
    individualScores: [
      ...
      },
      {
        ...
        overallScore: 7.5,
        comments:
          "Good team but concerned about competitive landscape. Market timing is uncertain.",
      ...
      },
      {
        ...
        overallScore: 8.4,
        comments:
          "Impressive traction with Fortune 500 pilots. Unit economics look solid.",
    ...
    individualScores: [
      {
        ...
        overallScore: 7.55,
        comments:
          "Strong product promise; still early on traction and reimbursement clarity.",
    ...
    individualScores: [
      {
        ...
        overallScore: 8.0,
        comments:
          "Large TAM and proven deployment velocity. Unit economics need more data.",
      ...
      },
      {
        ...
        overallScore: 8.25,
        comments:
          "Strong traction with strategic partners. Competitive but differentiated.",
    ...
    individualScores: [
      {
        ...
        overallScore: 7.45,
        comments:
          "Crowded market, but mid-market focus could win. Needs clearer differentiation.",
      ...
      },
      {
        ...
        overallScore: 7.65,
        comments:
          "Solid team and execution cadence. Want more proof on expansion.",
    ...
    individualScores: [
      {
        ...
        overallScore: 7.2,
        comments:
          "Promising traction with restaurant groups. Needs deeper margin story.",
      ...
      },
      {
        ...
        overallScore: 6.7,
        comments:
          "Customer pain is real but product differentiation is modest.",
...
export function getMockCompanyScoreData(
  companyId: number,
  companyName: string,
): CompanyScoreData {
