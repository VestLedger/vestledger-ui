...
export const mockIntegrations: IntegrationSummary[] = [
  {
    ...
    name: "Calendar",
    description:
      "Sync meetings and deadlines with Google Calendar, Outlook, and more",
    icon: "calendar",
    status: "connected",
  ...
  },
  {
    ...
    name: "Email",
    description:
      "Connect your email for deal flow tracking and LP communications",
    icon: "email",
    status: "available",
  ...
  },
  {
    ...
    name: "GitHub",
    description:
      "Track technical due diligence and code metrics for portfolio companies",
    icon: "github",
    status: "coming-soon",
