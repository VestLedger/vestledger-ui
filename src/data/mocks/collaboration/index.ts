...
export const mockCollaborationMessages: CollaborationMessage[] = [
  {
    ...
    authorRole: "analyst",
    message:
      "Uploaded updated TAM model. Need GP review before committee packet lock.",
  ...
  },
  {
    ...
    authorRole: "gp",
    message:
      "Please add downside sensitivity and a short note on competitive moat.",
...
export const mockCollaborationTasks: CollaborationTask[] = [
  {
    ...
    description:
      "Incorporate memo feedback and lock packet for Monday committee.",
    ownerRole: "analyst",
  ...
  },
  {
    ...
    description:
      "Follow up with LP operations contacts and confirm portal downloads.",
    ownerRole: "ir",
  ...
  },
  {
    ...
    description:
      "Link latest sanctions run output in compliance evidence folder.",
