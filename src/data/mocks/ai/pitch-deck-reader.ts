...
export const mockAnalyses: PitchDeckAnalysis[] = [
  {
    ...
    summary: {
      ...
      solution:
        "Quantum-classical hybrid AI platform that makes quantum computing accessible through simple APIs",
      marketSize: {
        tam: "$50B",
        sam: "$8B",
        som: "$500M",
      ...
      businessModel:
        "SaaS with usage-based pricing. $10k/month base + compute credits",
      traction: [
      ...
      team: {
        founders: [
          "Sarah Chen (ex-Google Quantum AI)",
          "Dr. Michael Zhang (MIT PhD Quantum Computing)",
        ],
  ...
  },
  {
    ...
    summary: {
      ...
      problem:
        "Paralysis patients lack effective communication and mobility solutions",
      solution:
        "Non-invasive BCI that translates brain signals into digital commands",
      marketSize: {
        tam: "$35B",
        sam: "$5B",
        som: "$280M",
      ...
      team: {
        founders: [
          "Dr. Alex Martinez (Stanford Neuroscience)",
          "Lisa Chen (ex-Neuralink Engineer)",
        ],
