...
export const portfolioDocuments: PortfolioDocument[] = [
  ...
  {
    id: 2,
    name: "Board Meeting Minutes - November",
    category: "board-materials",
  ...
  {
    id: 4,
    name: "Monthly Financial Report - November",
  ...
  {
    id: 5,
    name: "Q3 2024 Financial Package",
    category: "financial-reports",
    status: "current",
    companyId: 2,
    companyName: "BioTech Labs",
  ...
  {
    id: 7,
    name: "Monthly Financial Report - October",
    category: "financial-reports",
    status: "overdue",
    companyId: 3,
    companyName: "CloudScale",
  ...
  {
    id: 10,
    name: "Annual Audit Package 2024",
    category: "compliance",
    status: "overdue",
    companyId: 3,
    companyName: "CloudScale",
  ...
  {
    id: 11,
    name: "Insurance Renewal Documents",
    category: "compliance",
    status: "pending-review",
    companyId: 5,
  ...
  {
    id: 12,
    name: "Monthly Investor Update - November",
  ...
  // Pre-Investment DD (historical reference)
  {
    ...
    category: "pre-investment-dd",
    status: "current",
    companyId: 1,
    companyName: "Quantum AI",
    uploadedBy: "Investment Team",
    uploadedDate: "Jan 10, 2022",
    size: "2.4 MB",
    frequency: "one-time",
  },
  {
...
export const portfolioDocumentCategories: Array<{
...
}> = [
  {
    ...
    description: "Decks, minutes, consents",
  },
  {
    id: "financial-reports",
    name: "Financial Reports",
    description: "Monthly/quarterly/annual reports",
  },
  {
    id: "compliance",
    name: "Compliance Docs",
    description: "Audits, SOC2, legal",
  },
  {
    id: "investor-updates",
    name: "Investor Updates",
    description: "LP communications",
  },
  {
    id: "pre-investment-dd",
