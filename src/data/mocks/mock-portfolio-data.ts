...
export const portfolioUpdates: PortfolioUpdate[] = [
  {
    ...
    description:
      "Platform crossed 1 million active users milestone, 3 months ahead of schedule. User engagement metrics exceed industry benchmarks by 40%.",
    date: "2024-11-28",
  ...
  },
  {
    ...
    description:
      "Successfully launched enterprise-grade platform with advanced security features. Already secured 3 Fortune 500 customers in beta.",
    date: "2024-11-27",
  ...
  },
  {
    ...
    description:
      "Beginning Series B fundraising process. Target raise of $30M at $100M pre-money valuation. Strong investor interest from healthcare-focused VCs.",
    date: "2024-11-25",
  ...
  },
  {
    ...
    description:
      "ARR grew 42% QoQ to $22M. Net dollar retention at 135%. Gross margins improved to 78%. On track for cash flow positive by Q2 2025.",
    date: "2024-11-30",
  ...
  },
  {
    ...
    description:
      "Hired VP of Sales from Snowflake and VP of Engineering from Databricks. Both bring 15+ years of experience scaling data companies.",
    date: "2024-11-29",
    author: "Alex Kim, CEO",
  },
  {
    ...
    description:
      "Launched AI-powered code assistant in beta. Early metrics show 35% improvement in developer productivity. 5,000 waitlist signups in first week.",
    date: "2024-11-28",
...
export const portfolioSummary = {
  ...
  totalInvested: portfolioCompanies.reduce(
    (sum, c) => sum + c.initialInvestment,
    0,
  ),
  totalCurrentValue: portfolioCompanies.reduce(
    (sum, c) => sum + (c.currentValuation * c.ownership) / 100,
    0,
  ),
  averageMOIC:
    portfolioCompanies.reduce((sum, c) => sum + c.moic, 0) /
    portfolioCompanies.length,
  averageIRR:
    portfolioCompanies.reduce((sum, c) => sum + c.irr, 0) /
    portfolioCompanies.length,
  activeCompanies: portfolioCompanies.filter((c) => c.status === "active")
    .length,
  averageHealthScore:
    portfolioCompanies.reduce((sum, c) => sum + c.healthScore, 0) /
    portfolioCompanies.length,
};
