...
export const mockFunds: Fund[] = [
  {
    ...
    regulatoryProfile: {
      ...
      domicile: 'India',
      reportingNotes: 'Category II AIF with quarterly trustee and investor reporting.',
      india: {
  ...
  },
  {
    ...
    regulatoryProfile: {
      ...
      legalStructure: 'SCSp',
      domicile: 'Luxembourg',
      reportingNotes: 'Annex IV reporting with cross-border marketing across core EU markets.',
      eu: {
  ...
  },
  {
    ...
    regulatoryProfile: {
      ...
      reportingNotes: 'US private fund using standard quarterly LP reporting and annual tax issuance.',
      us: {
