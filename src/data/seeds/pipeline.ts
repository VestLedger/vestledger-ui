...
export const pipelineStages = ['sourced', 'first_meeting', 'due_diligence', 'term_sheet', 'closed'];

export const pipelineDeals: PipelineDeal[] = [
  { id: 1, name: 'Quantum AI', stage: 'due_diligence', outcome: 'active', sector: 'AI/ML', amount: '$2.5M', probability: 75, founder: 'Sarah Chen', lastContact: '2 days ago' },
  { id: 2, name: 'BioTech Labs', stage: 'term_sheet', outcome: 'active', sector: 'Healthcare', amount: '$1.8M', probability: 85, founder: 'Dr. James Wilson', lastContact: '1 day ago' },
  { id: 3, name: 'CloudScale', stage: 'due_diligence', outcome: 'active', sector: 'SaaS', amount: '$3.2M', probability: 70, founder: 'Maria Rodriguez', lastContact: '3 days ago' },
  { id: 4, name: 'FinFlow', stage: 'first_meeting', outcome: 'active', sector: 'FinTech', amount: '$2.0M', probability: 45, founder: 'Alex Kumar', lastContact: '1 week ago' },
  ...
  { id: 6, name: 'EcoEnergy', stage: 'first_meeting', outcome: 'active', sector: 'CleanTech', amount: '$4.0M', probability: 50, founder: 'John Park', lastContact: '5 days ago' },
  { id: 7, name: 'NeuroLink', stage: 'due_diligence', outcome: 'active', sector: 'MedTech', amount: '$2.8M', probability: 80, founder: 'Lisa Zhang', lastContact: '1 day ago' },
