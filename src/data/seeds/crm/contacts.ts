...
export const mockContacts: Contact[] = [
  {
    ...
    notes:
      "Strong technical background. Stanford PhD. Previously led AI team at Google.",
...
export const mockInteractions: Interaction[] = [
  {
    ...
    date: "2024-11-25",
    notes:
      "Discussed product roadmap and go-to-market strategy. Very positive.",
  },
  {
    id: "2",
    contactId: "1",
...
export const mockTimelineInteractions: TimelineInteraction[] = [
  ...
  },
  {
    ...
    description:
      "Discussed valuation, allocation, and board seat requirements.",
  ...
  },
  {
    ...
    description:
      "Deep dive into technology architecture, team background, and market opportunity.",
