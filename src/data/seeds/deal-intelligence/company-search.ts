...
export const mockCompanies: Company[] = [
  {
    ...
    name: "NeuralFlow AI",
    description:
      "Enterprise AI platform for automated document processing and workflow optimization",
  ...
  },
  {
    ...
    description:
      "Carbon accounting and ESG reporting platform for Fortune 500 companies",
    industry: "CleanTech",
  ...
  },
  {
    ...
    name: "SecureAuth Pro",
    description:
      "Zero-trust identity and access management for distributed enterprises",
