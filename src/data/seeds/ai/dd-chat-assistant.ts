...
export const getMockDDChatResponse = (
  query: string,
  dealName?: string,
): Message => {
  ...
  if (lowerQuery.includes("risk") || lowerQuery.includes("red flag")) {
    return {
      ...
      insights: [
        ...
        {
          type: "negative",
          text: "Early-stage market with adoption uncertainty",
        },
        {
          type: "positive",
          text: "Strong founding team mitigates execution risk",
        },
      ],
      relatedDocs: [
  ...
  if (
    ...
    return {
      ...
      insights: [
        {
          type: "positive",
          text: "CloudScale has exceptional unit economics (8.9x)",
        },
        { type: "neutral", text: "Quantum AI shows healthy 4.9x ratio" },
        {
          type: "negative",
          text: "NeuroLink ratio of 3.2x is below optimal for medical devices",
        },
      ],
      suggestedQuestions: [
