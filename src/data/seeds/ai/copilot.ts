...
export const getMockCopilotPageSuggestions = (
  ...
  return (
    baseSuggestions[contextKey] ||
    baseSuggestions[pathname] || [
      {
        id: "default",
...
export const getMockCopilotQuickActions = (
  ...
  const baseActions: Record<string, QuickAction[]> = {
    ...
    "/fund-admin": [
      {
        ...
        icon: Sparkles,
        action: "Generate capital call",
      },
      {
        id: "track-lps",
        label: "Track LPs",
        icon: Zap,
        action: "Show LP status",
      },
    ],
    "/contacts": [
      {
        id: "filter-cold",
        label: "Filter Cold Contacts",
        icon: Zap,
        action: "Show inactive contacts",
      },
      {
        id: "export-list",
    ...
    "/lp-management": [
      {
        ...
        label: "Send Reports",
        icon: Sparkles,
        action: "Distribute quarterly reports",
      },
      {
        id: "track-calls",
        label: "Track Capital Calls",
        icon: Zap,
        action: "Show LP responses",
      },
    ],
    "/deal-intelligence": [
      {
        id: "analyze-flow",
        label: "Analyze Deal Flow",
        icon: Sparkles,
        action: "Run trend analysis",
      },
      {
        id: "check-bottlenecks",
        label: "Check Bottlenecks",
        icon: Zap,
        action: "Identify DD delays",
      },
    ],
    "/dealflow-review": [
      {
    ...
    "/analytics": [
      ...
      },
      {
        ...
        label: "Analyze MOIC",
        icon: Zap,
        action: "Top return drivers",
      },
    ],
    "/compliance": [
      {
        id: "address-overdue",
        label: "Address Overdue",
        icon: Sparkles,
    ...
    "/409a-valuations": [
      {
        ...
        icon: Sparkles,
        action: "Request new valuation",
      },
      {
        id: "flag-events",
        label: "Flag Material Events",
        icon: Zap,
        action: "Identify trigger events",
      },
    ],
    "/tax-center": [
      {
        id: "distribute-k1s",
        label: "Distribute K-1s",
        icon: Sparkles,
        action: "Send ready K-1s",
      },
      {
        id: "send-reminders",
        label: "Send Reminders",
        icon: Zap,
        action: "Email filing deadline",
      },
    ],
    "/reports": [
      {
    ...
    "/contacts:email": [
      {
        ...
        label: "Compose Email",
        icon: Sparkles,
        action: "Draft new email",
      },
      {
        id: "sync-now",
        label: "Sync Emails Now",
        icon: Zap,
        action: "Force sync all accounts",
      },
    ],
    ...
    "/lp-portal:reports": [
      {
        ...
        label: "Generate Report",
        icon: Sparkles,
        action: "Create quarterly report",
      },
      {
        id: "customize-template",
        label: "Customize Template",
        icon: Zap,
        action: "Edit report format",
      },
    ],
    "/lp-portal:capital": [
      {
    ...
    "/lp-portal:performance": [
      {
        ...
        icon: Sparkles,
        action: "Download performance data",
      },
      {
        id: "compare-benchmark",
        label: "Compare to Benchmark",
        icon: Zap,
        action: "Load peer data",
      },
    ],
    "/lp-portal": [
      {
    ...
    "/lp-management:overview": [
      {
        ...
        icon: Sparkles,
        action: "Show LP metrics",
      },
      {
        id: "review-subscriptions",
        label: "Review Subscriptions",
        icon: Zap,
        action: "Check commitments",
      },
    ],
    "/lp-management:reports": [
      {
    ...
    "/lp-management:performance": [
      {
        ...
        label: "Generate Pack",
        icon: Sparkles,
        action: "Create performance pack",
      },
      {
        id: "analyze-returns",
        label: "Analyze Returns",
        icon: Zap,
        action: "LP cohort analysis",
      },
    ],
    // Tab-specific for Deal Intelligence page
    "/deal-intelligence:fund-level": [
      {
        ...
        icon: Sparkles,
        action: "Create pipeline summary",
      },
      {
        id: "dd-status",
        label: "DD Status Overview",
        icon: Zap,
        action: "Show all DD progress",
      },
    ],
    "/deal-intelligence:per-deal": [
      {
        ...
        icon: Sparkles,
        action: "Analyze deal risks",
      },
      {
        id: "share-summary",
        label: "Share Deal Summary",
        icon: Zap,
        action: "Export deal memo",
      },
    ],
    ...
    "/fund-admin:capital-calls": [
      {
        ...
        label: "Draft Capital Call",
        icon: Sparkles,
        action: "Generate capital call notice",
      },
      {
        id: "send-reminders",
        label: "Send LP Reminders",
        icon: Zap,
        action: "Bulk reminder emails",
      },
    ],
    "/fund-admin:distributions": [
      {
        ...
        icon: Sparkles,
        action: "Run waterfall calculation",
      },
      {
        id: "prepare-notices",
        label: "Prepare Notices",
        icon: Zap,
        action: "Generate distribution notices",
      },
    ],
    "/fund-admin:lp-responses": [
      {
        ...
        label: "Track Responses",
        icon: Sparkles,
        action: "Show response dashboard",
      },
      {
        id: "send-bulk-reminder",
        label: "Send Bulk Reminders",
        icon: Zap,
        action: "Email pending LPs",
      },
    ],
    "/fund-admin:nav-calculator": [
      {
        ...
        label: "Calculate NAV",
        icon: Sparkles,
        action: "Run NAV calculation",
      },
      {
        id: "export-nav",
        label: "Export NAV Report",
        icon: Zap,
        action: "Download NAV analysis",
      },
    ],
    "/fund-admin:carried-interest": [
      {
        ...
        icon: Sparkles,
        action: "Run carry accrual",
      },
      {
        id: "forecast-dist",
        label: "Forecast Distribution",
        icon: Zap,
        action: "Project carry payments",
      },
    ],
    "/fund-admin:expenses": [
      {
        ...
        icon: Sparkles,
        action: "Auto-classify expenses",
      },
      {
        id: "budget-check",
        label: "Check Budget",
        icon: Zap,
        action: "Show budget variance",
      },
    ],
    "/fund-admin:secondary-transfers": [
      {
        ...
        icon: Sparkles,
        action: "Open pending transfer",
      },
      {
        id: "rofr-calc",
        label: "Calculate ROFR",
        icon: Zap,
        action: "Run ROFR valuation",
      },
    ],
    ...
    "/compliance:filings": [
      {
        id: "prepare-adv",
        label: "Prepare Form ADV",
        icon: Sparkles,
        action: "Start ADV update",
      },
      {
        id: "state-renewals",
        label: "State Renewals",
        icon: Zap,
        action: "Show renewal status",
      },
    ],
    "/compliance:audits": [
      {
        ...
        icon: Sparkles,
        action: "Generate audit prep list",
      },
      {
        id: "findings-review",
    ...
    "/compliance:resources": [
      {
        id: "sec-guidance",
        label: "View SEC Guidance",
        icon: Sparkles,
        action: "Show latest rules",
      },
      {
        id: "schedule-training",
        label: "Schedule Training",
        icon: Zap,
        action: "Book compliance training",
      },
    ],
    ...
    "/tax-center:k1-generator": [
      {
        ...
        label: "Generate K-1s",
        icon: Sparkles,
        action: "Create K-1 package",
      },
      {
        id: "review-allocations",
        label: "Review Allocations",
        icon: Zap,
        action: "Verify tax allocations",
      },
    ],
    "/tax-center:fund-summary": [
      {
        ...
        label: "Tax Summary",
        icon: Sparkles,
        action: "Generate fund summary",
      },
      {
        id: "prior-year-compare",
        label: "Compare Prior Year",
        icon: Zap,
        action: "Show variance analysis",
      },
    ],
    "/tax-center:portfolio": [
      {
        ...
        label: "Follow Up",
        icon: Sparkles,
        action: "Email missing K-1s",
      },
      {
        id: "estimate-impact",
        label: "Estimate Tax Impact",
        icon: Zap,
        action: "Calculate exit tax",
      },
    ],
    "/tax-center:communications": [
      {
        id: "draft-memo",
        label: "Draft Tax Memo",
        icon: Sparkles,
        action: "Create LP memo",
      },
      {
        id: "extension-notice",
        label: "Extension Notice",
        icon: Zap,
        action: "Send extension alerts",
      },
    ],
    ...
    "/409a-valuations:strike-prices": [
      {
        ...
        label: "Review Grants",
        icon: Sparkles,
        action: "Show recent grants",
      },
      {
        id: "vesting-analysis",
        label: "Vesting Analysis",
        icon: Zap,
        action: "Analyze vesting terms",
      },
    ],
    "/409a-valuations:history": [
      {
        ...
        icon: Sparkles,
        action: "Chart FMV trends",
      },
      {
        id: "methodology-review",
        label: "Review Methods",
        icon: Zap,
        action: "Compare methodologies",
      },
    ],
    ...
    "/analytics:j-curve": [
      {
        id: "project-curve",
        label: "Project J-Curve",
        icon: Sparkles,
        action: "Forecast trajectory",
      },
      {
        id: "compare-funds",
        label: "Compare Funds",
        icon: Zap,
        action: "Multi-fund comparison",
      },
    ],
    "/analytics:cohort": [
      {
        ...
        label: "Find Outliers",
        icon: Sparkles,
        action: "Identify high performers",
      },
      {
        id: "sector-analysis",
        label: "Sector Analysis",
        icon: Zap,
        action: "Compare by sector",
      },
    ],
    "/analytics:valuation": [
      {
        ...
        icon: Sparkles,
        action: "Show markup trends",
      },
      {
        id: "forecast-gains",
        label: "Forecast Gains",
        icon: Zap,
        action: "Project year-end value",
      },
    ],
    "/analytics:deployment": [
      {
        ...
        label: "Pace Analysis",
        icon: Sparkles,
        action: "Compare vs plan",
      },
      {
        id: "reserve-strategy",
        label: "Reserve Strategy",
        icon: Zap,
        action: "Optimize reserves",
      },
    ],
    "/analytics:risk": [
      {
      ...
      },
      {
        ...
        icon: Zap,
        action: "Check allocation limits",
      },
    ],
    ...
    "/portfolio:overview": [
      {
        ...
        icon: Sparkles,
        action: "Show companies needing help",
      },
      {
        id: "health-trends",
        label: "Health Trends",
        icon: Zap,
        action: "Analyze trend data",
      },
    ],
    "/portfolio:updates": [
      {
        ...
        icon: Sparkles,
        action: "Read pending updates",
      },
      {
        id: "schedule-meetings",
        label: "Schedule Meetings",
        icon: Zap,
        action: "Book board meetings",
      },
    ],
    "/portfolio:documents": [
      {
        id: "follow-up-docs",
        label: "Follow Up Docs",
        icon: Sparkles,
        action: "Request missing reports",
      },
      {
        id: "organize-docs",
        label: "Organize Documents",
    ...
    "/ai-tools:pitch-deck-reader": [
      {
        ...
        label: "Upload Deck",
        icon: Sparkles,
        action: "Analyze pitch deck",
      },
      {
        id: "extract-metrics",
        label: "Extract Metrics",
        icon: Zap,
        action: "Pull key data points",
      },
    ],
    "/ai-tools:dd-assistant": [
      {
        id: "ask-question",
        label: "Ask DD Question",
        icon: Sparkles,
  ...
  // Try context-specific (pathname:tab) first, fall back to pathname only
  return (
    baseActions[contextKey] ||
    baseActions[pathname] || [
      {
        id: "help",
