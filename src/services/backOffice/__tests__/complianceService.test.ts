...
describe("complianceService", () => {
  ...
  it("returns centralized mock data in mock mode", async () => {
    ...
    await expect(service.getComplianceItems()).resolves.toEqual(
      mockComplianceItems,
    );
    await expect(service.getRegulatoryFilings()).resolves.toEqual(
      mockRegulatoryFilings,
    );
    await expect(service.getAuditSchedule()).resolves.toEqual(
      mockAuditSchedule,
    );
  });
